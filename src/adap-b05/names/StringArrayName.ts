...
export class StringArrayName extends AbstractName {
    ...
    insert(i: number, c: string) {
            ...
            MethodFailedException.assertCondition(orginalSize+1 === this.getNoComponents(), "Concat failed at appending the object"); //First check if num comp is right
        }
    ...
    append(c: string) {
        ...
        MethodFailedException.assertCondition(orginalSize+1 === this.getNoComponents(), "Concat failed at appending the object"); //First check if num comp is right
        MethodFailedException.assertCondition(this.getComponent(orginalSize) === c, "Component didn't not add string to new component"); // then if component string is added
    ...
    remove(i: number) {
        ...
        MethodFailedException.assertCondition(this.getNoComponents() === orginalSize-1, "Remove failed, length has not been updated");
        this.invariantsCheck();
    }
